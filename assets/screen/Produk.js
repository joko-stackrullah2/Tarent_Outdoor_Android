...
const Produk = ({navigation, route}) => {
  ...
  const getProduk = (role, id_user) => {
    ...
    if (role != 'admin') {
      FullUrl =
        url +
        'api/produk?id_kategori=' +
        route.params.KategoriId +
        '&id_user=' +
        id_user;
    } else {
      FullUrl =
        url + 'api/produk?id_kategori=' + route.params.KategoriId + '&id_user=';
    }
    console.log(FullUrl);
  ...
  const ItemProduk = ({
    ...
    <TouchableOpacity
      ...
      onPress={() => editProduk(id_produk, nama_produk, harga_sewa, stok)}>
      <View
        style={{alignItems: 'flex-start', justifyContent: 'center', flex: 1.2}}>
      ...
      <View style={{marginLeft: 10, flex: 6}}>
        ...
        <Text
          style={{color: 'black', fontFamily: 'Inter-Regular', fontSize: 10}}>
          Harga Sewa: {harga_sewa} /Hari
        </Text>
      </View>
      ...
      {RoleUser ? (
        <TouchableOpacity
          ...
          onPress={() => hapusProduk(id_produk, nama_produk)}>
  ...
  const ItemDistribusi = ({id_user, nama_agent, stok}) => (
    <TouchableOpacity
      ...
      onPress={() => AturStok(id_user, nama_agent)}>
      <View
        style={{alignItems: 'flex-start', justifyContent: 'center', flex: 1.2}}>
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              Anda dapat melakukan perubahan pada produk ini
            </Text>
            <View
              style={{
                borderWidth: 1,
              ...
              <TextInput
                ...
                onChangeText={NamaProdukEdit =>
                  setNamaProdukEdit(NamaProdukEdit)
                }
                style={{
                  color: 'black',
                  fontFamily: 'Inter-Regular',
            ...
            <View
              ...
              <TextInput
                ...
                keyboardType="numeric"
                onChangeText={HargaSewaProdukEdit =>
                  setHargaSewaProdukEdit(HargaSewaProdukEdit)
                }
                style={{
                  color: 'black',
                  fontFamily: 'Inter-Regular',
            ...
            <Text
              ...
              Anda harus mendistribusikan produk ini ke setiap agen Terent
              Outdoor, klik tombol dibawah ini!
            </Text>
            <TouchableOpacity
              style={{
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              Apakah anda yakin ingin menghapus Produk "{NamaProdukEdit}"?
            </Text>
            <TouchableOpacity
              style={{
                backgroundColor: 'green',
              ...
              onPress={() => HapusProduk(IDEditProduk)}>
              <Text
                style={{
                  color: 'white',
                  fontFamily: 'Inter-Bold',
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              Silahkan pilih nama agen di bawah ini
            </Text>
